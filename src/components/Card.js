        ...
        <div className='card'>
            ...
            <div className='row'>
                <div className='col-2-of-3'>
                    <p className='card__info'>Cena: ${numberWithCommas(props.price)}</p>
                    <p className='card__info'>Pokoje: {props.bedrooms}</p>
                    <p className='card__info'>Łazienki: {props.bathrooms}</p>
                </div>
                <div className='col-1-of-3'>
                    <p className='card__saletype'>{props.sale_type}</p>
                    <p className='card__hometype'>{props.home_type}</p>
                    <p className='card__sqft'>Metraż: {props.sqft}</p>
                </div>
            </div>
            <Link className='card__link' to={`/listings/${props.slug}`}>Pokaż ogłoszenia</Link>
        </div>
    );
};
