...
const ListingDetail = (props) => {
    ...
    return (
        <div className='listingdetail'>
            <Helmet>
                <title>Biuro Obrotu Nieruchomościami Bratki | {`${listing.title}`}</title>
                <meta
                    name='description'
            ...
            <div className='row'>
                <div className='col-1-of-2'>
                    <ul className='listingdetail__list'>
                        <li className='listingdetail__list__item'>Typ domu: {listing.home_type}</li>
                        <li className='listingdetail__list__item'>Cena: ${price}</li>
                        <li className='listingdetail__list__item'>Pokoje: {listing.bedrooms}</li>
                        <li className='listingdetail__list__item'>Łazienki: {listing.bathrooms}</li>
                        <li className='listingdetail__list__item'>Metraż: {listing.sqft}</li>
                    </ul>
                </div>
                <div className='col-1-of-2'>
                    <ul className='listingdetail__list'>
                        <li className='listingdetail__list__item'>Wynajem/Zakup: {listing.sale_type}</li>
                        <li className='listingdetail__list__item'>Adres: {listing.address}</li>
                        <li className='listingdetail__list__item'>Miasto: {listing.city}</li>
                        <li className='listingdetail__list__item'>Województwo: {listing.state}</li>
                        <li className='listingdetail__list__item'>Kod pocztowy: {listing.zipcode}</li>
                    </ul>
                </div>
            </div>
            <div className='row'>
